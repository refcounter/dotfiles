...
set_bg() {
  feh --bg-fill ~/.config/bspwm/rices/cristina/walls/cyberpunk.webp
}

# Launch the bar and or eww widgets
launch_bars() {
		$HOME/bin/eww/eww -c ~/.config/bspwm/rices/cristina/widgets/ daemon &
		polybar -q main -c ~/.config/bspwm/rices/cristina/config.ini &
}
