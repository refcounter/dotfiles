...
keys.globalkeys = gears.table.join(
   ...
   awful.key({modkey}, 'b', function() 
       awful.spawn('sensible-browser')
   end, {description = 'launch default web browser', group='launcher'}),
   -- launch rofi
   awful.key({modkey}, "d",
      function()
   ...
   awful.key({}, "XF86AudioNext",
      function()
         awful.spawn(apps.audio_remote .. " next", false)
      end,
      {description = "next music", group = "hotkeys"}
   ),
   awful.key({}, "XF86AudioPrev",
      function()
         awful.spawn(apps.audio_remote.." prev", false)
      end,
      {description = "previous music", group = "hotkeys"}
   ),
   awful.key({}, "XF86AudioPlay",
      function()
         awful.spawn(apps.audio_remote .." toggle", false)
      end,
