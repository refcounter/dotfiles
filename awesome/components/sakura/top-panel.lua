...
top_panel.create = function(s)
   ...
   panel:setup {
      ...
      {
        layout = wibox.layout.align.horizontal,
        wibox.layout.margin(require("widgets.layout-box"), dpi(23), dpi(5), dpi(8), dpi(3)),
        wibox.layout.margin(tag_list.create(s), dpi(25), dpi(5), 8, 8)
      },
     {
   ...
   tag.connect_signal("property::selected", function(t)
    ...
    -- ===================================================================
   -- Functionality extracted from bottom-panel
   -- ===================================================================
