...
apps = {
   ...
   terminal = "urxvt",
   launcher = 'rofi -show drun -theme ~/.config/rofi/launchers/type-1/style-11.rasi',
   window_switcher = 'rofi -show window -theme ~/.config/rofi/launchers/type-1/style-11.rasi',
   lock = "i3lock",
...
local run_on_start_up = {
   --"picom --config /home/zura/.config/picom/picom.conf" ,
   "/home/zura/autostart",
   "/home/zura/mount_drives",
}
